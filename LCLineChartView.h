...
@property float yMin,yMin2,yMinForGraph2;
@property float yMax,yMax2,yMaxForGraph2;
@property (strong) NSArray *ySteps,*yStepsRight,*ySteps2,*xSteps; /// Array of step names (NSString). At each step, a scale line is shown.
